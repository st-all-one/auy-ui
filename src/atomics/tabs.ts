...
/**
 * @slot tab - Default slot for tab elements when not using `tabs` property
 * @slot panel - Default slot for panel content when not using `tabs` property
 * @slot panel-{id} - Panel content for tab with given id
 */
@customElement('auy-internal-tabs')
export class AuyInternalTabs extends LitElement {
