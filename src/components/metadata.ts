...
export class AuyCompMetadata extends LitElement {
  ...
  override render() {
    return html`<div data-element="metadata" style="display:none"><style>${metaStyles}</style></div>`;
  }
}
