 ...
 */
@customElement('auy-error-503')
export class AuyError503 extends AuyLightElement {
  ...
  @property({ type: String }) message = 'Serviço indisponível';
  @property({ type: String }) description = 'O sistema está em manutenção. Tente novamente mais tarde.';
  @property({ type: String }) homeUrl = '/';
  @property({ type: String }) homeLabel = 'Verificar disponibilidade';
