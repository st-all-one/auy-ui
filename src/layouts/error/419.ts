 ...
 */
@customElement('auy-error-419')
export class AuyError419 extends AuyLightElement {
  ...
  @property({ type: String }) message = 'Sessão expirada';
  @property({ type: String }) description = 'Sua sessão expirou por inatividade. Faça login novamente para continuar.';
  @property({ type: String }) loginUrl = '/login';
  @property({ type: String }) loginLabel = 'Fazer login';
  @property({ type: String }) retryLabel = 'Atualizar página';
