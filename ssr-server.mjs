  ...
  <html lang="pt-BR">
    ...
    <body>
      ...
      <div class="section">
        <h2>Button</h2>
        <div class="row">
          <auy-comp-button variant="primary">Primary</auy-comp-button>
          <auy-comp-button variant="secondary">Secondary</auy-comp-button>
          <auy-comp-button variant="ghost">Ghost</auy-comp-button>
          <auy-comp-button loading loading-text="Aguarde...">Loading</auy-comp-button>
        </div>
      </div>
      ...
      <div class="section">
        <h2>Badge</h2>
        <div class="row">
          <auy-comp-badge variant="success">Success</auy-comp-badge>
          <auy-comp-badge variant="error">Error</auy-comp-badge>
          <auy-comp-badge variant="warning">Warning</auy-comp-badge>
          <auy-comp-badge variant="info">Info</auy-comp-badge>
          <auy-comp-badge variant="neutral">Neutral</auy-comp-badge>
          <auy-comp-badge count="42" variant="error"></auy-comp-badge>
          <auy-comp-badge count="150" max="99" variant="warning"></auy-comp-badge>
        </div>
      </div>
      ...
      <div class="section">
        <h2>Spinner</h2>
        <div class="row">
          <auy-comp-spinner size="24"></auy-comp-spinner>
          <auy-comp-spinner size="32"></auy-comp-spinner>
          <auy-comp-spinner size="48" color="var(--auy-color-success, #10b981)"></auy-comp-spinner>
        </div>
      </div>
      ...
      <div class="section">
        <h2>Card</h2>
        <div class="grid-2">
          <auy-comp-card variant="elevated">
            ...
            <auy-comp-button slot="footer" variant="primary">Action</auy-comp-button>
          </auy-comp-card>
          <auy-comp-card variant="outlined" href="#demo">
            <div slot="title">Outlined (Link)</div>
            <div slot="description">This card is an anchor element with the outlined variant.</div>
            <auy-comp-button slot="footer" variant="secondary">Learn More</auy-comp-button>
          </auy-comp-card>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <auy-admin-layout style="min-height: 300px; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
          <auy-admin-header slot="header" style="border-bottom: 1px solid #e5e7eb; padding: 0.5rem 1rem; background: #f9fafb; display: flex; justify-content: space-between; align-items: center;">
            <strong>auy-ui App</strong>
            <auy-comp-button variant="ghost" size="sm">Login</auy-comp-button>
          </auy-admin-header>
          <auy-admin-sidebar slot="sidebar" style="background: #f3f4f6; padding: 1rem; width: 200px;">
          ...
          <auy-admin-main-section slot="main" style="padding: 1rem;">
            <h3>Main Content</h3>
            <p>This is the primary content area rendered inside the layout. It uses slot-based composition.</p>
            <auy-comp-button variant="primary">Get Started</auy-comp-button>
          </auy-admin-main-section>
          <auy-admin-footer slot="footer" style="border-top: 1px solid #e5e7eb; padding: 1rem; text-align: center; font-size: 0.875rem; color: #6b7280;">
      ...
      <div class="section">
        ...
        <div class="row">
          <auy-comp-badge variant="success">SSR Component</auy-comp-badge>
          <span class="fallback-demo">Static Fallback</span>
        </div>
        <pre>${unsafeHTML(`
&lt;!-- If SSR fails for a component, provide static fallback: --&gt;
&lt;auy-comp-badge variant="warning"&gt;SSR Rendered&lt;/auy-comp-badge&gt;
&lt;noscript&gt;
